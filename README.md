# genpark-contextual-workspace-web-agent-browser-skill
...
> **GenPark AI Agent Skill** -- Contextual multi-space browser workspace and boost manager (Arc Browser style)
